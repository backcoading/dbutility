...
import com.omc.dbUtility.rms.dto.GraphDTO.Graphs;

public class GraphEnergyDTO {

	private List<GraphEnergy> graphEnergies;
	...
	public List<GraphEnergy> getGraphEnergies() {
		return graphEnergies;
	}

	public void setGraphEnergies(List<GraphEnergy> graphEnergies) {
		this.graphEnergies = graphEnergies;
	}
