...
public class DgResponseDTO extends AbstractResponseDTO {
	...
	private String othDgrh;

	private BigDecimal othFreqHz;

	private BigDecimal othFuelLevelLtr;
	...
	public void setOmcId(String string) {
		this.omcId = string;
	}
	...
	public String getOthDgrh() {
		return othDgrh;
	}

	public void setOthDgrh(String othDgrh) {
	...
	public BigDecimal getOthFuelLevelLtr() {
		return othFuelLevelLtr;
	}

	public void setOthFuelLevelLtr(BigDecimal othFuelLevelLtr) {
